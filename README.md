...
> 初版 README(2026-06-05)的论点至今有效:要爽感 → 得撒手把"认知"交出去;要敢撒手 → 验证必须便宜 + 爆炸半径有界。**不敢撒手的根子不是不信任 AI,是验证太贵。** 契约 / 审计 / 仪式这些控制机器,只在换来真实的跟踪、协作、隔离或交付价值时才配存在——它们为"敢撒手"服务,不是目的。爽感在"AI 干了我没想到的事,而且还不错"那条线上,别把这种瞬间从流程里工程掉。
...
- exp-048:重新对齐初心——北极星重立(度量 = 杠杆/爽感 + 行为,方法 = 验证做便宜);audit 补行为面抽查;家规加出题税;实测发现撒手实验字段 7-14 起消失一个月无人察觉。
