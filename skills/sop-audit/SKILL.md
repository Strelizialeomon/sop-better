---
name: sop-audit
description: 给项目的"开发 SOP"做体检——头号查过度治理(仪式吃掉 AI 杠杆),也查结构错配 / 反驳缺失 / 结构缺失 / 凭据失真。对照 sop-better/STANDARD.md,出"人读报告 + 可执行 findings"双轨。默认只出报告;owner 明确说"改 / go"才动手修(走 issue/PR 工作流)。给老项目体检、怀疑 SOP 太重 / 不一致时用。
---
